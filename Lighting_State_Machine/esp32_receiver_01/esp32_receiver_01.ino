...
#define STRIP_ID 1  // Change this for each ESP32 (0, 1, 2, 3)

// WiFi Configuration
const char* ssid = "LightingHUB";
const char* password = "JpopKpop";
const char* newHostname = "LED_RECEIVER_01";
...
// Packet buffering
#define BUFFER_SIZE 8  // Buffer up to 8 packets for smoother animations
struct PacketBuffer {
